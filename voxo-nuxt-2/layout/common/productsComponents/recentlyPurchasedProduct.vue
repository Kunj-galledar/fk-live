<template>
  <div
    class="recently-purchase d-md-flex d-none"
    :style="{ bottom: showPurchased }"
    v-if="visiblePurchase"
  >
    <img
      src="~assets/images/fashion/instagram/3.jpg"
      class="img-fluid"
      alt=""
    />
    ...
    <a
      ...
      class="close-popup fa fa-times"
      @click="(showPurchased = '-200px'), (show = false)"
    ></a>
  </div>
</template>
