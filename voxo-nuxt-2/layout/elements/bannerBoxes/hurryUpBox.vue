  ...
  >
    <div class="offer-wrap product-style-1">
      <div class="row g-xl-4 g-3">
        <div
          class="col-lg-4"
          v-for="(section, index) in tab.children"
          :key="index"
          :class="getSectionClasses(section)"
        >
          <div
            class="product-banner product-banner-circle"
            v-if="section.childtype === 'middlebanner'"
          >
                ...
                <ul class="rating rating-2">
                  <li>
                    <i
                      ...
                      v-for="(stars, index5) in section.ratingstars"
                      :key="'a' + index5"
                    ></i>
                  </li>
                  <li>
                    <i
                      class="fas fa-star"
                      v-for="(stars, index6) in 5 - section.ratingstars"
                      :key="'b' + index6"
                    ></i>
                  </li>
                </ul>
          ...
          <div class="product-list" v-else>
            <div
              class="product-box"
              :class="productBoxClasses"
              v-for="(banner, index2) in section.banners"
              :key="'c' + index2"
            >
              <div class="img-wrapper">
                <a
              ...
              <div class="product-details">
                ...
                <ul class="rating">
                  <li
                    v-for="(stars, index3) in banner.ratingstars"
                    :key="'d' + index3"
                  >
                  ...
                  <li
                    v-for="(stars, index4) in 5 - banner.ratingstars"
                    :key="'e' + index4"
                  >
