...
import blogLeft from "~/layout/common/blogComponents/blogLeftSection1.vue";
import { mapState } from "vuex";
export default {
  components: { blogRight, blogLeft },
  data() {
    return {
      pages: [],
      cardsToShow: 9,
  ...
  computed: {
    ...mapState({
      blogsList: (state) =>
        state.blogData.data.filter((item) => item.type === "blogListing")[0]
          .blogs,
    }),
  },
  methods: {
