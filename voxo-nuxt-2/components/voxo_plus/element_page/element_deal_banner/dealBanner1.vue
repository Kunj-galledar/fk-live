              ...
              <div class="discount-image-details">
                <div class="discount-images">
                  ...
                  <img
                    ...
                    alt=""
                    class="img-fluid shoes-images-1"
                  />
                  <img
                    :src="getImageUrl(banner.image)"
                    alt=""
                    class="img-fluid shoes-images-2"
                  />
                </div>
                ...
                <div class="discunt-details mt-xl-0 mt-4">
                  <div>
                    ...
                    <h5 class="mt-3">
                      {{ banner.title }}
                      <span class="theme-color">{{ banner.discount }}</span>
                    </h5>
                    ...
                    >
                      <ul>
                        ...
                        <li>
                          <div class="counter">
                            <div>
                              <h2 id="hours1" class="theme-color">
                                {{ hours }}
                              </h2>
                              Hour
                            </div>
