    ...
    <div class="cloth-review">
      <nav>
        <div class="nav nav-tabs" id="nav-tab">
          <button
            class="nav-link"
            :class="tabActive['description'] ? 'active' : ''"
            id="nav-home-tab"
            type="button"
          ...
          <button
            class="nav-link"
            id="nav-speci-tab"
            :class="tabActive['Specifications'] ? 'active' : ''"
            type="button"
          ...
          <button
            class="nav-link"
            id="nav-size-tab"
            :class="tabActive['sizingGuide'] ? 'active' : ''"
            type="button"
      ...
      <div class="tab-content" id="nav-tabContent">
        <transition>
            ...
            <div class="shipping-chart">
              ...
              <div class="row g-3 align-items-center">
                ...
                <div class="col-lg-4 order-lg-0 mt-4">
                  <img
                    src="~assets/images/fashion/slider/2.jpg"
                    class="img-fluid rounded"
                    alt=""
                  />
                </div>
          ...
          <div
            class="tab-pane show active"
            id="speci"
            v-else-if="tabActive['Specifications']"
          >
            <div class="pro mb-4">
              <p class="font-light">
          ...
          <div
            class="tab-pane overflow-auto show active"
            id="nav-guide"
            v-else-if="tabActive['sizingGuide']"
          >
            <div class="table-responsive">
