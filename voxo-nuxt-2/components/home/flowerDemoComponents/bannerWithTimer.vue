        ...
        <div class="col-md-12">
          <div class="discount-image-details-2">
            <div class="discount-images">
              <img
                :src="getImageUrl(banner.leftimage)"
                class="img-fluid flower-images-1"
                alt=""
              />
              <img
                :src="getImageUrl(banner.rightimage)"
                class="img-fluid flower-images-2"
                alt=""
              />
            </div>
  ...
  methods: {
    setTimerValues() {
      ...
      setInterval(() => {
        ...
        // if ((Math.floor(((countDown - now) % hour) / minute)) < 10) {
