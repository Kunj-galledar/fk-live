          ...
          >
            <div class="slider-right-detail">
              <div class="labels">
                <ul class="label-15">
                  <li
                    v-for="(social, index) in item.socialIcons"
                    :key="'A' + index"
                  >
                    <a :href="social.website">
                      <img
                        :src="getImageUrl(social.iconImage)"
                        class="img-fluid"
                        alt="facebook"
                        draggable="false"
                      />
                ...
                <div class="relative-shoes">
                  ...
                  <div class="shoes-price">
                    ...
                    <ul class="rating d-flex justify-content-between">
                      <li
                        v-for="(stars, index2) in item.leftReviewStars"
                        :key="index2"
                      >
                        <i class="fas fa-star theme-color"></i>
                      </li>
                      <li
                        v-for="(stars, index2) in 5 - item.leftReviewStars"
                        :key="'A' + index2"
                      >
            ...
            <div class="price-number">
              <h2>
                {{ selectedCurrencySymbol }}{{ item.bottomPrice
                }}<span
                  ><del
                    >{{ selectedCurrencySymbol }}{{ item.bottomMrp }}</del
                  ></span
                >
              </h2>
...
<script>
import { ShoesMainSlider } from "~/static/data/SliderSettingsData";
