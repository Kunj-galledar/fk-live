        ...
        <div class="col-md-12">
          <div class="discount-image-details">
            <div class="discount-images">
              ...
              <img :src="getImageUrl(banner.image)" alt="" class="img-fluid shoes-images-1" />
              <img :src="getImageUrl(banner.image)" alt="" class="img-fluid shoes-images-2" />
            </div>
            ...
            <div class="discunt-details mt-xl-0 mt-4">
              <div>
                ...
                <h5 class="mt-3">
                  {{banner.title}} <span class="theme-color">{{banner.discount}}</span>
                </h5>
                <h2 class="my-3 deal-text">
                  {{banner.headingtop}}<br />{{banner.headinbottom}}
                ...
                <div class="timer-style-2 mt-xl-1 my-2 justify-content-center d-flex">
                  <ul>
                    <li>
                      <div class="counter">
                        <div>
                          <h2 id="days1" class="theme-color">{{ days }}</h2>
                          Days
                        </div>
                      </div>
                    </li>
                ...
                <nuxt-link to="/shop/shop_canvas_filter" type="button"
...
<script>
  export default {
    ...
    methods: { getImageUrl(path) { return require('@/assets/images/' + path) } },
    mounted() {
      var second = 1000,
        minute = second * 60,
        hour = minute * 60,
