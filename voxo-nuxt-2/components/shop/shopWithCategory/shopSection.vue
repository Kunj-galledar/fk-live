    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-9 col-12 ratio_30">
          <!-- Prodcut setion -->
          <topCategories />
          <h3 class="mb-lg-0 mb-3">25 Results Found</h3>
          <div class="row g-4">
            <div class="col-12">
              <!-- filter button -->
            ...
            <options @changeCardLayout="changeCardLayout" />
          </div>
          <!-- label and featured section -->
...
<script>
import filterBar from "~/layout/common/shopComponents/filterBar3.vue";
import topCategories from "./topCategories.vue";
import options from "~/layout/common/shopComponents/options1.vue";
