      ...
      <div class="category-image">
        ...
        <div class="category-contain">
          ...
          <ul class="product-list">
            <li
              v-for="(brand, index) in brands[category].brands"
              :key="'a' + index"
            >
              <a
...
export default {
  ...
  computed: {
    ...
    allProducts() {
      return this.$store.state.filters.allCards;
    },
  },
  methods: {
    applyFilter(brand) {
  ...
  created() {
    ...
    this.categories.forEach((category) => {
      ...
      image = require("@/assets/images/" + categoryProducts[0].images[0].src);
      brands = [...new Set(brands)];
      brands.splice(brands.indexOf(brands["none"]), 1);
