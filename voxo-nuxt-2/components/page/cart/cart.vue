<template>
  <section class="cart-section section-b-space">
    <div class="container">
      <div class="row">
        <div class="col-12" v-if="cartItems.length != 0">
          <div class="count-down">
            <h5>
              Your cart will be expired in
              <span class="count-timer theme-color" id="timer"></span>
              minutes !
            </h5>
            <button
              type="button"
        ...
        >
          <img
            :src="require('@/assets/images/cartEmpty.png')"
            class="img-fluid"
          />
          <animatedButton
        ...
        <cartTable :cartItems="cartItems" v-if="cartItems.length != 0" />
...
import cartTable from "~/components/page/cart/cartTable.vue";
