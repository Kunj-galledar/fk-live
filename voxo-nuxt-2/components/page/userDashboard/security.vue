<template>
  <div
    class="tab-pane fade dashboard-security dashboard show active"
    id="security"
  >
    <div class="box-head">
    ...
    <div class="security-details">
      <h5 class="font-light mt-3">Hi <span> Mark Enderess,</span></h5>
    ...
    <div class="security-details-1 mb-0">
      ...
      <p class="font-light mb-4">
        ...
        to delete your account, than click below
      </p>

      <button
        class="btn btn-solid-default btn-sm fw-bold rounded"
