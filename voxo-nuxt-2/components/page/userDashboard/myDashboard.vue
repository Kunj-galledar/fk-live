<template>
  <div class="tab-pane fade show active show" id="dash">
        ...
        <div class="order-box-contain my-4">
          <div class="row g-4">
            <div class="col-lg-4 col-sm-6">
              <div class="order-box">
                <div class="order-box-image">
                  <img src="~assets/images/svg/box.png" class="img-fluid" alt="" />
                </div>
                <div class="order-box-contain">
                  <img src="~assets/images/svg/box1.png" class="img-fluid" alt="" />
                  <div>
            ...
            <div class="col-lg-4 col-sm-6">
              <div class="order-box">
                <div class="order-box-image">
                  <img src="~assets/images/svg/sent.png" class="img-fluid" alt="" />
                </div>
                <div class="order-box-contain">
                  <img src="~assets/images/svg/sent1.png" class="img-fluid" alt="" />
                  <div>
            ...
            <div class="col-lg-4 col-sm-6">
              <div class="order-box">
                <div class="order-box-image">
                  <img src="~assets/images/svg/wishlist.png" class="img-fluid" alt="" />
                </div>
                <div class="order-box-contain">
                  <img src="~assets/images/svg/wishlist1.png" class="img-fluid" alt="" />
                  <div>
