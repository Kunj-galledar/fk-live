...
document.addEventListener('DOMContentLoaded', function() {
  ...
  menuItems.forEach(function(item) {
    item.addEventListener('click', function(event) {
      ...
      // // Check if an active menu item is found
      // if (activeMenuItem) {
      //   // Get the offset top of the active menu item
      //   var offsetTop = activeMenuItem.offsetTop - 400;

      //   // Animate the scrolling to the offset top
      //   $(".main-sidebar .sidebar nav .nav-sidebar .nav-item .nav-link").animate({
      //     scrollTop: offsetTop
      //   }, 1000);
      // }
    });
...
// // For keep images as it is even after page load START
// (function($) {
//   $(document).ready(function() {
//       // Get the image ID from the cookie
//       var selectedImageId = Cookies.get('selected_image_id');

//       // If there is a selected image, highlight it
//       if (selectedImageId) {
//           var selectedImage = $('input[type="radio"][value="' + selectedImageId + '"]');
//           if (selectedImage.length) {
//               selectedImage.prop('checked', true);
//           }
//       }

//       // Save the selected image ID to the cookie when a radio button is clicked
//       $('input[type="radio"][name="image"]').on('click', function() {
//           Cookies.set('selected_image_id', $(this).val());
//       });
//   });
// })(django.jQuery);
// // For keep images as it is even after page load END
