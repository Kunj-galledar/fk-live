...
$("#darkButton").on("click", function () {
  if ($("body").hasClass("light")) {
    ...
    document
      ...
      .setAttribute("href", "/voxo/voxoapp/static/assets/css/" + split + "_dark.css");
  } else {
    var href = $("#color-link").attr("href");
    ...
    document
      .getElementById("color-link")
      .setAttribute("href", "/voxo/voxoapp/static/assets/css/" + split + ".css");
  }
});
...
$(".rtl-button").on("click", function () {
  if ($("body").hasClass("ltr")) {
    ...
    $("body").addClass("rtl");
    $(this).text("LTR");
    $("#rtl-link").attr("href", "/voxo/voxoapp/static/assets/css/vendors/bootstrap.rtl.css");
  } else {
    $("html").attr("dir", "");
    $("body").removeClass("rtl");
    $(this).text("RTL");
    $("body").addClass("ltr");
    $("#rtl-link").attr("href", "/voxo/voxoapp/static/assets/css/vendors/bootstrap.css");
  }
});