...
class BannerTheme(models.Model):
    ...
    bannerThemeName = models.CharField(
...
class BannerType(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    bannerTypeName = models.CharField(
        max_length=255, verbose_name='Name')
    slug = models.SlugField(unique=True, blank=True)
...
class Banner(models.Model):
    ...
    titleFour = models.CharField(max_length=255, blank=True, verbose_name='Title Four')
    ...
    # def save(self, *args, **kwargs):
    #     self.slug = slugify(self.titleOne)
...
class ContactUs(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    # contactUsByUser=models.ForeignKey(CustomUser,on_delete=models.CASCADE,blank=True,verbose_name='User')
