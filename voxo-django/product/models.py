...
class Product(models.Model):
    ...
    productType = models.CharField(max_length=255, choices=productTypeChoices, verbose_name='Type')
    ...
    productDescription = RichTextField(blank=True, null=True, verbose_name='Description')
    productImageFront = models.ImageField(verbose_name='Front Image', upload_to='fashion/product/front')
...
class ProductReview(models.Model):
    ...
    # productNoOfReview = models.PositiveIntegerField(blank=True, null=True, default=0, verbose_name='No. of Review')
    # productRatingCount = models.PositiveIntegerField(blank=True, null=True, default=0, verbose_name='Rating Count')
    # productFinalRating = models.PositiveIntegerField(blank=True, null=True, default=0, verbose_name='Rating (5)')
