...
class WalletHistory(models.Model):
    ...
    # walletHistoryCreditByUser=models.ForeignKey(Wallet, on_delete=models.CASCADE,verbose_name='Credited By User')
...
class Withdrawal(models.Model):
    ...
    statusOptionChoices = [('Pending', 'Pending'), ('Approve', 'Approve'), ('Rejecte', 'Rejecte')]
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    ...
    # withdrawalStatus = models.BooleanField(default=False, verbose_name='Approved')
    ...
    def save(self, *args, **kwargs):
        ...
        # Make unnnn-comment after testing
        # =======================================
